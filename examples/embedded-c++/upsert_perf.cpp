...
int main(int argc, char* argv[]) {
  ...
  {  
    ...
    //auto plan = con.Query("EXPLAIN (FORMAT HTML) INSERT INTO key_values (k,v) SELECT k,v FROM inserts ON CONFLICT (k) DO UPDATE SET v = EXCLUDED.v");
    //plan->Print();
